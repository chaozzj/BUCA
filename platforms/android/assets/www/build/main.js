...
var TRIPS = [
    {
        id: 1,
        name: "Toyota Urban cruiser 2012 en Montoya | Vendo Poderoso, Económico y seguro TOYOTA Urban cruiser",
        price_adult: 11000,
        price_child: 30,
        time: "12h",
        free_cancellation: 1,
        electric_voucher: 1,
        sub_name: "Toyota Urban cruiser 2012",
        thumb: "assets/img/trip/thumb/1.jpg",
        description: "Único dueño, comprado en Autonica, motor 1.3cc, 6 bolsas de aires (4 adelante y 2 asientos traseros), todos los mantenimientos al dia. Jamás ha sido chocado, excelente estado mecánico (disponible para someterse a inspección de mecánicos experimentados de Toyota), llantas Pirelli nuevas.GPS Antirrobo Integrado.El más Alto en su clase con rines 16.",
        location: "Tijuana",
        images: [
            "assets/img/trip/thumb/1.jpg",
            "assets/img/trip/thumb/2.jpg",
            "assets/img/trip/thumb/3.jpg",
        ],
        highlights: [
            "Toyota",
            "Urban cruiser",
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, keyboard) {
        ...
        this.initializeApp();
        this.appMenuItems = [
            { title: 'Inicio', component: __WEBPACK_IMPORTED_MODULE_5__pages_home_home__["a" /* HomePage */], icon: 'home' },
            { title: 'Autos Nuevos', component: __WEBPACK_IMPORTED_MODULE_7__pages_local_weather_local_weather__["a" /* LocalWeatherPage */], icon: 'car' },
            { title: 'Autos Semi Nuevos', component: __WEBPACK_IMPORTED_MODULE_7__pages_local_weather_local_weather__["a" /* LocalWeatherPage */], icon: 'car' },
            { title: 'Autos Usados', component: __WEBPACK_IMPORTED_MODULE_7__pages_local_weather_local_weather__["a" /* LocalWeatherPage */], icon: 'car' },
            { title: 'Mejores Ofertas', component: __WEBPACK_IMPORTED_MODULE_7__pages_local_weather_local_weather__["a" /* LocalWeatherPage */], icon: 'star' },
            { title: 'Lista de Deseos', component: __WEBPACK_IMPORTED_MODULE_7__pages_local_weather_local_weather__["a" /* LocalWeatherPage */], icon: 'checkmark' }
        ];
    }
...
var HomePage = (function () {
    function HomePage(storage, nav, popoverCtrl) {
        ...
        // search condition
        this.search = {
            name: "Tijuana, Baja California Norte",
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        this.storage.get('pickup').then(function (val) {
            if (val === null) {
                _this.search.name = "Tijuana, Baja California Norte";
            }
            else {
...
LoginPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-login',template:/*ion-inline-start:"/home/chaozzj/Documents/car/src/pages/login/login.html"*/'<!-- -->\n<ion-content padding class="animated fadeIn login auth-page">\n  <div class="login-content">\n\n    <!-- Logo -->\n    <div padding-horizontal text-center class="animated fadeInDown">\n      <div class="logo"></div>\n      <h2 ion-text class="text-primary">\n        <strong>BUCA</strong>\n      </h2>\n    </div>\n\n    <!-- Login form -->\n    <form class="list-form">\n      <ion-item>\n        <ion-label floating>\n          <ion-icon name="mail" item-start class="text-primary"></ion-icon>\n          Email\n        </ion-label>\n        <ion-input type="email"></ion-input>\n      </ion-item>\n\n      <ion-item>\n        <ion-label floating>\n          <ion-icon name="lock" item-start class="text-primary"></ion-icon>\n          Contraseña\n        </ion-label>\n        <ion-input type="password"></ion-input>\n      </ion-item>\n    </form>\n\n    <p text-right ion-text color="secondary" tappable (click)="forgotPass()"><strong>¿Olvidó su contraseña?</strong></p>\n\n    <div>\n      <button ion-button icon-start block color="dark" tappable (click)="login()">\n        <ion-icon name="log-in"></ion-icon>\n        INICIAR SESION\n      </button>\n\n      <p text-center ion-text color="secondary">O utiliza tus redes sociales:</p>\n\n      <ion-grid>\n        <ion-row>\n          <ion-col col-4>\n            <button ion-button icon-only block class="btn-facebook">\n              <ion-icon name="logo-facebook"></ion-icon>\n            </button>\n          </ion-col>\n          <ion-col col-4>\n            <button ion-button icon-only block class="btn-twitter">\n              <ion-icon name="logo-twitter"></ion-icon>\n            </button>\n          </ion-col>\n          <ion-col col-4>\n            <button ion-button icon-only block class="btn-gplus">\n              <ion-icon name="logo-googleplus"></ion-icon>\n            </button>\n          </ion-col>\n        </ion-row>\n      </ion-grid>\n\n    </div>\n\n\n    <!-- Other links -->\n    <div text-center margin-top>\n      <span ion-text color="secondary" tappable (click)="register()">¿Ere nuevo? <strong>Registrate</strong></span>\n    </div>\n\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/chaozzj/Documents/car/src/pages/login/login.html"*/
    }),
